...
if(isset($_POST['save']))
{
	if (!empty($_FILES['photo']['name'])) {
		@$files=$obj->upload_image($w,$h,$thumb,"photo",'teacher');
		$photo=$files;
	} else {
	...
	{
		if($obj->insert($table,array("name"=>$_POST['name'],"subject"=>$_POST['subject'],"position"=>$_POST['position'],"degree"=>$_POST['degree'],"photo"=>$photo,"school_id"=>$school,"date"=>date('Y-m-d'),"status"=>1))==1)
                ...
                <div class="st_detail_topbar">
                    <a href="#">
                        <div class="topbar_small_div left ">
                            ...
                            <div class="topbar_small_div_text left height-30">Teacher</div>
                        </div>
                        <div class="topbar_small_div_text2 left height-30"><h2>Add New Teacher</h2></div>
                    </a>
                ...
                <div style="clear:both; ">
                    ...
                    <div class="admission_div shadow_inner" style="margin-top: 20px; height:auto;">
                        <div class="admission_text_div height-40" style="border-bottom: 5px #CCCCCC ridge;">
                            <h2 class="margin_left30"><left>Add Teacher Detail :</left></h2>
                        </div>
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            <ul>
                                ...
                                <li class="admission_form_div_label height-30 width-label-250 right">
                                    <input name="name" placeholder="Type Name" class="textbox" type="text" />
                                </li>
                                <li class="admission_form_div_label height-30 width-label-200 left">Position <span class="right">:</span></li>
                                <li class="admission_form_div_label height-30 width-label-250 right">
                                    <input name="position" placeholder="Type Position Here" value="Teacher"  class="textbox" type="text" />
                                </li>
                                <li class="admission_form_div_label height-30 width-label-200 left">Subject <span class="right">:</span></li>
                                <li class="admission_form_div_label height-30 width-label-250 right">
                                    <input name="subject" placeholder="Type Subject Here"  class="textbox" type="text" />
                                </li>
