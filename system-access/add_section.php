...
if(isset($_POST['save']))
{
   if($obj->exists_multiple($table,array("name"=>$_POST['name'],"class_id"=>$_POST['class'],"school_id"=>$school,"session_id"=>$_POST['session']))==0)
	{
	...
	{
		echo $obj->Error("Already Failed",$obj->filename()."?class_id=".$_POST['class']."&session_id=".$_POST['session']);	
	}
}
