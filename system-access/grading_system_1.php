    ...
    <head>
        ...
        <script>
            function showee(str)
            {
                ...
                xmlhttp.open("GET", "ajx/abotun16.php?s="+str, true);
                xmlhttp.send();
            }
</script>
                ...
                <div class="st_detail_topbar">
                    <a href="#">
                        <div class="topbar_small_div left">
                            ...
                            <div class="topbar_small_div_text left height-30">Grading System</div>
                        </div>
                    ...
                    <div class="admission_div_top shadow_inner" style="padding-bottom:70px;">
                        ...
                        <ul>
                            ...
                            <li id="df" style="clear: both; display: block; width: 100%; padding: 10px; text-align: center;">
                                    ...
                                    <button type="submit" name="submit" class="height-35 div_btn" >Create View</button>
                                </li>
                        </ul>
                    </div>
