                ...
                <div class="st_detail_topbar">
                    <a href="#">
                        <div class="topbar_small_div left ">
                            ...
                            <div class="topbar_small_div_text left height-30">Chairman</div>
                        </div>
                        <div class="topbar_small_div_text2 left height-30"><h2>Add New Chairman	</h2></div>
                    </a>
                ...
                <div style="clear:both; ">
                    ...
                    <div class="admission_div shadow_inner" style="margin-top: 20px; height:auto;">
                        <div class="admission_text_div height-40" style="border-bottom: 5px #CCCCCC ridge;">
                            <h2 class="margin_left30"><left>Add  Chairman Detail :</left></h2>
                        </div>
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            <ul>
                                ...
                                <li class="admission_form_div_label height-30 width-label-250 right">
                                    <input name="name" placeholder="Type Chairman Name" class="textbox" type="text" />
                                </li>
