            ...
            <div class="st_detail_body">
                <div class="st_detail_topbar ">
                    <a href="#">
                        ...
                        <div class="topbar_small_div_text2 left height-30"><h2>Transport SETTING</h2></div>
                    </a>
                    <div class="topbar_small_div right">
                        <ul>

                            <li style="clear: both; display: block; width: 100%; padding: 10px; text-align: center;">
                                <a href="settings_to.php" style="text-decoration:none;">
                ...
                <div style="clear:both; ">
                    ...
                    <div class="attendance_mode_div shadow_inner color_1" style="margin-top: 20px; ">
                        <div class="admission_text_div height-40 " style="border-bottom: 5px #CCCCCC ridge;">
                            <h2 class="margin_left30"><left>SELECT Transport SETTING MODE :</left></h2>
                        </div>
                        <div class="admission_mode_form_div width-col4 auto-position">
                            <div class="attendance_doc_small_div left shadow_inner">
                                <a href="class_time_table_setting.php"><img src="images/class_time_Icon.png" style="height: 60px; width:60px;" class="autoposition margin-top-10"/></a>
                                </br>
                                <a href="transport_setting_profile.php" class="attendance_doc_small_div_text autoposition">Transport profile  </a>
                            </div>
                            <div class="attendance_doc_small_div right shadow_inner">
                                ...
                                <a href="transport_setting_profile_list.php" class="attendance_doc_small_div_text autoposition">Transport List</a>
                            </div>
                        <div class="clear"></div>
