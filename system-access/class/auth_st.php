...
if(!isset($_SESSION['SESS_AMSIT_STLOGIN_KEY']) || (trim($_SESSION['SESS_AMSIT_STLOGIN_KEY']) == '')) 
{
...
$school=$_SESSION['SESS_SESSION_STSCHOOL_ID'];
$input_by=$_SESSION['SESS_AMSIT_STLOGIN_KEY'];
