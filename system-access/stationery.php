...
$table="ams_stationery";
if(isset($_POST['save']))

{
	if($obj->exists_multiple($table,array("name"=>$_POST['name'],"taka"=>$_POST['taka'],"school_id"=>$school))==0 && !empty($_POST['name']) && !empty($_POST['taka']))
	{
    ...
    <head>
        ...
        <script>
            function subjectedit(str)
            {
                ...
                xmlhttp.open("GET", "ajx/edit_stytionery.php?s=" + str, true);
                xmlhttp.send();
            }
        </script>
    </head>
            ...
            <div class="st_detail_body">
                <div class="st_detail_topbar">
                    <a href="#">
                        ...
                        <div class="topbar_small_div_text2 left height-30"><h2>ADD STATIONERY FINANCE</h2></div>
                    </a>
                ...
                <div style="clear:both; ">
                    ...
                    <div class="admission_div shadow_inner" style="margin-top: 20px; height:auto;">
                        <div class="admission_text_div height-40" style="border-bottom: 5px #CCCCCC ridge;">
                            <h2 class="margin_left30"><left>ADD STATIONERY FINANCE:</left></h2>
                        </div>
