...
if(@$_GET['action']=='delete')
{
    if($obj->delete($table,array("id"=>$_GET['id']))==1)
    {
             ...
             if($error_flag)
             {
                 ...
                 session_write_close();
                 header('location: '.$obj->filename()."?id=".$id."&showstudent=".$school);
                 exit();
             } 
     }
     else
                    ...
                    <div class="admission_div_top shadow_inner" style="padding-bottom:70px;">
                        ...
                        <ul style="margin-left:10px;">
                            ...
                            <li id="df" style="clear: both; display: block; width: 100%; padding: 10px; text-align: center;">
                                    ...
                                    <button type="submit" onclick="showstudent('2')" name="submit" class=" height-35 div_btn" >Show Class / Course</button>
                        ...
                        <!--tables code start from here-->
                            ...
                            <div  id="printableArea">
                                <table cellpadding="0" cellspacing="1" border="0" class="display" id="example">
                                    ...
                                    <tbody>
                                        <?php
										$array=array("school_id"=>$school,"group_id"=>$id); 
                                        ...
                                        <tr class="" style="font-weight:500;">
                                                ...
                                                <td><a title="clik to Edit" onclick="subjectedit('<?php echo $row->id; ?>')" href="student_profile_edit.php?student_id=<?php echo $row->id;?>&amp;eiinnumber=<?php echo $school; ?>"><i class="fa fa-edit"></i></a></td>
                                                <td  class="center">
                                ...
                                <div class="report_menu_div width-col3 right margin_bottom30">
