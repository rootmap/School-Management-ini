...
if(@$_GET['action']=='delete')
{
    ...
    {
           echo $obj->Success("Successfully delete","mgt_list.php");	 
     }
     else
     {
    ...
    <head>
        ...
        <script>
            function fullprofile(str)
            {
                ...
                xmlhttp.open("GET", "ajx/full_profile_manage.php?f=" + str, true);
                xmlhttp.send();
            }
        </script>
        ...
        <script>
            function genarel(str)
            {
                ...
                xmlhttp.open("GET", "ajx/general_manage.php?t=" + str, true);
                xmlhttp.send();
            }
        </script>
        ...
        <script>
            function personal(str)
            {
                ...
                xmlhttp.open("GET", "ajx/personall_manage.php?p=" + str, true);
                xmlhttp.send();
            }
        </script>
        ...
        <script>
            function contact(str)
            {
                ...
                xmlhttp.open("GET", "ajx/contact_manage.php?c=" + str, true);
                xmlhttp.send();
            }
        </script>
...
padding-left:20px;
                ...
                <div style="clear:both; ">
                    ...
                    <div class="profile_info_div_page" style="margin-top: 20px; height:auto; ">
                      <div class="admission_text_div height-40 " style="border-bottom: 5px #CCCCCC ridge;">
                        ...
                        <li><a href="edit_manage.php?id=<?php echo $id; ?>&amp;school=<?php echo $school; ?>">EDIT</a>
    ...
    <li class="width-label-120 left margin_left10">User ID<span class="right" style="padding-right:20px;">:</span></li>
    <li class="width-label-290 left">
      <?php echo $in->	id_number;?>
    </li>
    <li class="width-label-120 left margin_left10">Joining Date<span class="right" style="padding-right:20px;">:</span></li>
    <li class="width-label-290 left">
       <?php echo $in->joining_date;?>
     </li>
    <input type="hidden" id="st_profile_info.php<?php echo $in->id; ?>" name="id"/>
