                    ...
                    <div class="exam_result_div_top shadow_inner" >
                        <ul>
                            ...
                            <li class="add_st_form_div_label_view_details height-30 width-label-130 left">Group:</li>
                                ...
                                <li class="add_st_form_div_label_view_details height-30 width-label-70 left" style="text-align:left;">Exam :</li>
                    ...
                    <div class="exam_result_div_page" style="margin-top: 20px; ">
                        ...
                        {        ?>
                                ...
                                <td class="center"><?php echo $r;?></td>
                                        ...
                                        <td class="center"><a href="testimonial_view.php?id=<?php echo $row->admition; ?>&amp;group_id=<?php echo $row->group_id; ?>&amp;school=<?php echo $row->school_id; ?>">TM</a></td>
