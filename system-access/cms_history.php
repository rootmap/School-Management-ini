...
if(isset($_POST['save']))
{
	if (!empty($_FILES['photo']['name'])) {
		@$files=$obj->upload_image($w,$h,$thumb,"photo",'histoty');
		$photo=$files;
	} else {
		echo $obj->Error("Please Select A Photo for History message, Then Try Again.",$obj->filename());
	}
                ...
                <div class="st_detail_topbar">
                    <a href="#">
                        <div class="topbar_small_div left ">
                            ...
                            <div class="topbar_small_div_text left height-30">History</div>
                        </div>
                        <div class="topbar_small_div_text2 left height-30"><h2>Add Message in History	</h2></div>
                    </a>
                ...
                <div style="clear:both; ">
                    ...
                    <div class="admission_div shadow_inner" style="margin-top: 20px; height:auto;">
                        <div class="admission_text_div height-40" style="border-bottom: 5px #CCCCCC ridge;">
                            <h2 class="margin_left30"><left>Add  School History :</left></h2>
                        </div>
                       
                        <div id="sessionshow" class="admission_form_div width-col2 auto-position">
                        <form action="" method="post" enctype="multipart/form-data">
                            <ul>
                             	<li style="height:140px;" class="admission_form_div_label height-130 width-label-200 left">History Content<span class="right">:</span></li>
