...
if(isset($_POST['save']))
{
    if($obj->exists_multiple($table,array("table"=>$_POST['detail_table'],"session_id"=>$_POST['session'],"group_id"=>$_POST['group'],"class_id"=>$_POST['class'],"shift_id"=>$_POST['shift'],"school_id"=>$school))==0)
    {
        ...
        $obj->insert($table,array("table"=>$_POST['detail_table'],"section_id"=>$_POST['section'],"session_id"=>$_POST['session'],"group_id"=>$_POST['group'],"class_id"=>$_POST['class'],"shift_id"=>$_POST['shift'],"school_id"=>$school,"date"=>date('Y-m-d'),"stutas"=>1));
	}
            ...
            <div class="st_detail_body">
                <div class="st_detail_topbar">
                    <a href="#">
                        ...
                        <div class="topbar_small_div_text2 left height-30"><h2>TEACHERS TIME TABLE SETTING</h2></div>
                    </a>
...
<?php include('includes/back.php'); ?>
                ...
                <div style="clear:both; ">
                    <form action="" method="post" name="teacher">
                    ...
                    <div class="admission_div_page shadow_inner color_1" style="margin-top: 20px;">
                        <div class="admission_text_div height-40 " style="border-bottom: 5px #CCCCCC ridge;">
                            <h2 class="margin_left30"><left>Weekly Teachers Time and Day Setting :</left></h2>
                        </div>
