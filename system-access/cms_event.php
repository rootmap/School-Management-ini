...
{
	extract($_POST);
	if($obj->exists_multiple($table,array("name"=>$_POST['name'],"school_id"=>$school))==0 && !empty($_POST['name']) && !empty($_POST['detail']))
	{
		if($obj->insert($table,array("name"=>$_POST['name'],"detail"=>$_POST['detail'],"school_id"=>$school,"date"=>date('Y-m-d'),"status"=>1))==1)
                ...
                <div class="st_detail_topbar">
                    <a href="#">
                        <div class="topbar_small_div left ">
                            ...
                            <div class="topbar_small_div_text left height-30">Event</div>
                        </div>
                        <div class="topbar_small_div_text2 left height-30"><h2>Add New Event	</h2></div>
                    </a>
                ...
                <div style="clear:both; ">
                    ...
                    <div class="admission_div shadow_inner" style="margin-top: 20px; height:auto;">
                        <div class="admission_text_div height-40" style="border-bottom: 5px #CCCCCC ridge;">
                            <h2 class="margin_left30"><left>Add  Event Detail :</left></h2>
                        </div>
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            <ul>
                                ...
                                <li class="admission_form_div_label height-30 width-label-250 right">
                                    <input name="name" placeholder="Type Event Name" class="textbox" type="text" />
                                </li>
                                <li class="admission_form_div_label height-30 width-label-200 left">Detail <span class="right">:</span></li>
                                <li style="clear:right;" class="admission_form_div_label height-30 width-label-250 right">
                                    <textarea name="detail" placeholder="Type detail Here" class="textbox"></textarea>
                                </li>
