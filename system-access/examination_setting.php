    ...
    <head>
        ...
        <script>
            function showexam(str)
            {
                ...
                xmlhttp.open("GET", "ajx/exam.php?session="+ssession+"&class="+cclass, true);
                        ...
                        <div class="class_time_setting_small left margin_left25 width-label-250 margin-top-30">
                           ...
                           <div class="exam_setting_select_div width-label-150 left margin_left30 ">
                           	...
                           	<ul class="margin-top-75">
                            	<li class="auto-position"><a href="#"><!--<img src="images/forward_select_arrow.png"/>--></a></li>
                                <li class="auto-position"><a href="#"><!--<img src="images/backward_select_arrow.png"/>--></a></li>
                            </ul>
                           </div>
                           ...
                           <li style="clear: both; display: block; width: 100%; padding: 10px; text-align: center;">
                                    ...
                                    <span style="padding:10px;">Next Page</span>
                                    </a>
                                </li>
                                </ul>
