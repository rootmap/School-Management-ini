...
if($r!='')
{
	...
	?>               
	<?php
          $array=array("school_id"=>$school,"category_id"=>2,"group_id"=>$group);
         ...
         <table width="100%" cellspacing="1" >
                 ...
                 <td><a style="color:rgba(255,255,255,1);" target="new" href="edit_time_tablee1.php?id=<?php echo $row->id; ?>&amp;category=2&amp;school=<?php echo $school; ?>">Edit <i class="fa fa-edit"></i></a></td>
                 </tr>
