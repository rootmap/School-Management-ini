...
<form action="" method="post" name="ediit">
     ...
     <li class="admission_form_div_label height-30 width-label-200 left">Examation Name<span class="right">:</span></li>
        <li class="admission_form_div_label height-30 width-label-250 right">
            <input name="modee" value="<?php echo $ro->mode; ?>" type="text" placeholder="Type session Name Here" class="textbox"/> %
