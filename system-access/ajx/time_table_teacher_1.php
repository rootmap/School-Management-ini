...
if($k!='')
{
	...
	<?php
         ...
         <table width="100%" cellspacing="1" >
                 ...
                 <td><a style="color:rgba(255,255,255,1);" target="new" href="edit_time_tablee.php?id=<?php echo $row->id; ?>&amp;category=<?php echo $k; ?>&amp;school=<?php echo $school; ?>">Edit <i class="fa fa-edit"></i></a></td>
                 </tr>
