...
if($status==2){
            ...
            <div class="result_sheet">
                 ...
                 <table cellspacing="0">
                  ...
                  <tbody>
                  <?php 
						$array=array("admission_id"=>$admission,"exam_cateory_id"=>$ro->id,"school_id"=>$school);
					...
					?>
                     <tr>
                        ...
                        <td class="center">
                         ...
                         <?php 
						$array=array("subject_id"=>$ting->subject_id,"school_id"=>$school);
                         $data=$obj->SelectAllByID_Multiple("ams_marks_select",$array);
						 if(!empty($data))
                         foreach($data as $roo):
	...
	else
	{
        ...
        <div class="result_sheet">
                 ...
                 <table cellspacing="0">
                  ...
                  <tbody>
                  <?php 
						$array=array("admission_id"=>$admission,"exam_cateory_id"=>$d,"school_id"=>$school);
                         $data=$obj->SelectAllByID_Multiple($table,$array);
						 $x=1;
						 $c=0;
						 $t=0;
