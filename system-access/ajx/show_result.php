                   ...
                   <?php 
					...
					?>
                             ...
                             <div class="result_sheet_name left">
                              <div class="result_sheet_name_1 shadow_inner">School/College Name<?php echo $ting->school_id;?></div>
                  ...
                  <?php 
					...
					?>
                     <tr>
                        ...
                        <td class="center">
						 <?php  $sum=$ting->essy; echo $sum;?>
                        </td>
                        <td class="center">
                          <?php  $sum_s=$ting->mcq; echo $sum_s;?>
                        </td>
                        <td class="center">
	...
	else
	{
        ...
        <div class="result_sheet">
                 ...
                 <table cellspacing="0">
                  ...
                  <tbody>
                  <?php 
						$array=array("admission_id"=>$admission,"exam_cateory_id"=>$k);
                         $data=$obj->SelectAllByID_Multiple($table,$array);
						 $x=1;
						 $c=0;
						 $t=0;
