...
if($g!='')
{
	...
	?>               
	<?php
          $array=array("school_id"=>$school,"category_id"=>3,"group_id"=>$group);
         ...
         <table width="100%" cellspacing="1" >
                 ...
                 <td><a style="color:rgba(255,255,255,1);" target="new" href="edit_time_tablee2.php?id=<?php echo $row->id; ?>&amp;category=<?php echo $g; ?>&amp;school=<?php echo $school; ?>">Edit <i class="fa fa-edit"></i></a></td>
                 </tr>
