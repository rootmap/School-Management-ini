...
if($k!='')
{
	...
	?>               
	<?php
          $array=array("school_id"=>$school,"category_id"=>1,"group_id"=>$group);
         ...
         <table width="100%" cellspacing="1" >
                 ...
                 <td><a style="color:rgba(255,255,255,1);" target="new" href="edit_time_table1.php?id=<?php echo $row->id; ?>&amp;category=1&amp;school=<?php echo $school; ?>">Edit <i class="fa fa-edit"></i></a></td>
                 </tr>
                             <tr style="background:rgba(204,102,51,1)">
                              ...
                              <tr >
                               ...
                               <td style="background:rgba(0,153,204,.6)" rowspan="14"><?php echo $row->tffin; ?></td>
