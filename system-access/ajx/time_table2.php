...
if($g!='')
{
	...
	<?php
         ...
         <table width="100%" cellspacing="1" >
                 ...
                 <td><a style="color:rgba(255,255,255,1);" target="new" href="edit_time_table3.php?id=<?php echo $row->id; ?>&amp;category=3&amp;school=<?php echo $school; ?>">Edit <i class="fa fa-edit"></i></a></td>
                 </tr>
