...
<?php echo $obj->ShowMsg(); ?>
                    ...
                    <div class="mws-panel-header">
                        <span><i class="icon-plus"></i> Add New Product Item</span>
                    </div>
                    <div class="mws-panel-body no-padding">
                        ...
                        <div id="mws-validate-error" class="mws-form-message error" style="display:none;"></div>
                            <fieldset class="mws-form-inline">
                                ...
                                <label class="mws-form-label">Chose Catagory</label>
                                <div class="mws-form-item">
                                    <div id="mws-ui-button-radio">
                                        <input type="radio" id="radio1" name="radio" value="2"  onchange="showbutt(this.value)"><label for="radio1">Expense </label>
                                        <input type="radio" id="radio2" name="radio" value="1"  onchange="showbutt(this.value)"><label for="radio2">Asset</label>
                                    </div>
                                </div>
                            </div>
                            <div class="mws-form-row bordered" id="showcat">
