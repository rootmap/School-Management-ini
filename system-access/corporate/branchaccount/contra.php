           	  ...
           	  <div class="grid_8">
                    <div class="mws-panel">
                        <div class="mws-panel-header">
                            <span>Add New Contra Journal Transactions</span>
                        </div>
                        <div class="mws-panel-body no-padding">
                        <?php echo $obj->ShowMsg(); ?>
                            <form id="mws-validate"  class="mws-form" action="class_file/class/add_contra.php" method="post">
                            ...
                            <tbody id="POITable">
                                <tr>
                                    ...
                                    <select class="required small" style="margin-left:20px; width:200px;" name="option_a[]"  id="option_a">
                                                ...
                                                <?php
												$sql4=$obj->SelectAllByID("account_module_ladger_list_properties",array("main_head_id"=>4));
												foreach($sql4 as $row)
												{
												?>
                                                <option value="<?php echo $row->id; ?>"><strong><?php echo $row->head_sub_list_name; ?></strong></option>
                                                ...
                                                <?php
												$sql5=$obj->SelectAllByID("account_module_ladger_list_properties",array("main_head_id"=>5));
												foreach($sql5 as $row)
												{
												?>
                                                <option value="<?php echo $row->id; ?>"><strong><?php echo $row->head_sub_list_name; ?></strong></option>
                                    ...
                                    <td align="center" valign="middle"><input type="text" class="required small" style="width:100px; text-align:right;font-weight:bolder; " name="opt_a_debit[]" id="opt_a_debit" onKeyUp="addNumbers()" value="0"></td>
                                    <td align="center" valign="middle"><input type="text" class="required small" style="width:100px; text-align:right;font-weight:bolder; " name="opt_a_cradit[]" id="opt_a_cradit" onKeyUp="addNumbers_cradit()" value="0"></td>
                                </tr> <tr>
                                    <td align="center" valign="middle">
                                    <select class="required small" style="margin-left:20px; width:200px;" name="option_a[]"  id="option_a">
                                                <option selected>--------------------------</option>
