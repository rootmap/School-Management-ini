                    ...
                    <h3 align="center">From 01/01/2013 To <?php echo date('d/m/Y');  ?></h3>
                        <table class="mws-datatable-fn mws-table" style="margin-top:-30px;">
                            ...
                            <?php
									...
									$ld=$obj->SelectAllByID_Multiple("account_module_ladger",array("ladger_id"=>$ladger_id,"branch_id"=>$branch_id));
									if(!empty($ld))
									foreach($ld as $row)
									{
										$nj=$row->invoice_id;
									...
									?>   
									<?php 
									if($njc=="J"){ $linkname="viewjournal.php"; $linktitle="Journal"; $extraurl=""; }
                                    elseif($njc=="N"){ $linkname="viewinvoice.php"; $linktitle="Invoice";  $link_id=$row->link_id; $cid=$obj->SelectAllByVal("account_module_invoice","link_id",$link_id,"customer_id"); $extraurl="&link_id=".$link_id."&cid=".$cid; }
                                    elseif($njc=="B"){ $linkname="viewbill.php"; $linktitle="Bill"; $link_id=$row->link_id; $vendor_id=$obj->SelectAllByVal("account_module_bill","link_id",$link_id,"vendor_id"); $extraurl="&link_id=".$link_id."&vendor_id=".$vendor_id; }
									elseif($njc=="O"){ $linkname="view_officeexpense_voucher_ladger.php"; $linktitle="Office Expense "; $extraurl=""; }
									elseif($njc=="S"){ $linkname="view_transaction_salary.php"; $linktitle="Salary Voucher "; $extraurl=""; }
									else
									{
										$linkname="#"; $linktitle=""; $extraurl="";
									}
                                    ?>                         
									  <tr>
											<td valign="middle" align="left">
										   
											<a style="color:#000; font-size:18px; font-weight:bolder;" href="<?php echo $linkname; ?>?id=<?php echo substr($nj,1,1000); ?>&amp;branch_id=<?php echo $branch_id."".$extraurl; ?>"><?php echo $row->ladger_date; ?> ( <?php echo $linktitle; echo substr($nj,1,1000); ?> )</a>
											</td>
								...
								<table class="mws-table">
									<tbody><?php
											$getdutotala=$obj->SelectAllByID_Multiple("account_module_ladger",array("ladger_id"=>$ladger_id,"branch_id"=>$branch_id));
												$debitt=0;
												$craditt=0;
