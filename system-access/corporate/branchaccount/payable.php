                ...
                <div class="mws-panel grid_12">
                    ...
                    <div class="mws-panel-body no-padding">
                        <table class="mws-datatable mws-table">
                            ...
                            <tbody>
                            <?php 
							$qq=$obj->SelectAllByID("account_module_bill_payment",array("branch_id"=>$branch_id));
							if(!empty($qq))
							foreach($qq as $wow)
							{
							?>
                                <tr>
									...
									<a style="color:#03C !important; font-weight:bolder; font-size:16px;" href="viewbill.php?id=<?php echo $wow->bill_id; ?>&amp;link_id=<?php echo $wow->link_id; ?>&amp;vendor_id=<?php echo $wow->vendor_id; ?>&amp;branch_id=<?php echo $wow->branch_id; ?>">Voucher - 
