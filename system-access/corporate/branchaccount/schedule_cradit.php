...
<?php //include('header_footer_file/accjournalbalance.php'); ?>
                ...
                <!-- Panels Start -->
                	...
                	<div class="mws-panel-header">
                    	<span><i class="icon-table"></i> Inter Project Current Account Cradit  </span> 
                    </div>
                    <h2 style="text-align:center; border-left:#000 thick dotted; border-right:#000 thick dotted;">Inter Project Current Account Cradit </h2>
                    <div class="mws-panel-body no-padding">
                        <table class="mws-datatable-fn mws-table">
							...
							?>
                                <tr>
                                    <td valign="middle" align="left"><a style="color:#000; font-size:18px; font-weight:bolder;" href="viewledger.php?ladger_id=<?php echo $inid; ?>"><?php echo $row['head_sub_list_name']; ?></a></td>
                                    <td align="center" valign="middle"><?php echo $inid; ?></td>
                                    <td align="right" valign="middle"><?php echo number_format($cradit); ?></td>
                                </tr>
                             <?php 
							 } 
