                            ...
                            <form class="mws-form" action="#" method="post" name="form">
                                ...
                                <div class="mws-form-row">
									...
									foreach($sql_leds1 as $fetled1)
									{
                                        ...
                                        <a href="addpayment_bill.php?id=<?php echo $id; ?>&amp;due=<?php echo $qp1+$tax1;  ?>&amp;vendor_id=<?php echo $_GET['vendor_id']; ?>&amp;branch_id=<?php echo $branch_id; ?>&amp;link_id=<?php echo $_GET['link_id']; ?>" class="btn"><i class="icon-attachment"></i> Add Payment</a>
                                    </h3><hr>
                                    </div>
                                    	...
                                    	<div class="mws-form-cols">
                                      	<div class="mws-form-col-2-8">
                                            ...
                                            <div class="mws-form-item">
												...
												$branch=$obj->SelectAllByVal("ams_branch","id",$branch_id,"name");
