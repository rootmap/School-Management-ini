...
xmlhttp.open("GET","class_file/ajax/ajax_bill.php?id="+str<?php echo $a; ?>,false);
xmlhttp.send();
...
xmlhttp.open("GET","class_file/ajax/ajax_detail_bill.php?id="+str<?php echo $a; ?>,true);
xmlhttp.send();
}
                ...
                <!-- Panels Start -->
                    ...
                    <div class="mws-panel">
                        <div class="mws-panel-body no-padding">
                            <form class="mws-form" action="class_file/class/add_new_bill.php" method="post" name="form">
                                <div class="mws-form-inline">
                                <div class="mws-button-row">
                                    <div><i class="icol32-application-form-add"></i>
                                    <h2 style="margin-left:35px; margin-top:-37px; color:#030"> Add An Voucher</h2></div>
                                </div>
                                    ...
                                    <h3>
                                        <i style="margin-top:-15px;" class="icon-pushpin"></i> 
                                        	Voucher   
                                        <?php 
											@$chkinvoice=$obj->totalrows("account_module_invoice"); 
											if($chkinvoice==0) 
											{ echo "1"; } 
											else 
											{ echo $chkinvoice+1; } 
                                    ...
                                    <div class="mws-form-row" style="margin-top:-40px;">
                                    	<div class="mws-form-cols">
                                      	<div class="mws-form-col-2-8">
                                        		<label class="mws-form-label" style="text-align:center; font-weight:bolder; font-size:19px;">Chose Vendor/Customer </label>
                                                         
                     
                                            <div class="mws-form-item">
                                           <select class="required mws-select2 large" style="text-align:center;" name="customer_id">
                                           		<option value="">Chose Customer/Vendor</option>
											   <?php
                                    	...
                                    	</div> <input name="currency" type="hidden" value="5"/>
                                      	<?php /*?><div class="mws-form-col-2-8">
                                        
                                        		<label class="mws-form-label"  style="text-align:center; font-weight:bolder; font-size:19px;">Chose Branch</label>
                                            <div class="mws-form-item">
                                        ...
                                        <div class="mws-form-col-2-8">
                                            ...
                                            <div class="mws-form-item">
                                                 <input type="text" class="mws-datepicker large" readonly  value="<?php echo date('Y-m-d'); ?>"  name="duedate">
                                            </div>
                                    	</div>
                                        </div>                                          
                                    </div>
...
"></div>
                        ...
                        <table class="mws-table" id="myTable">
                            <thead>
                                <tr>
                                    <th align="center">Item</th><th align="center">Detail</th>
                                 ...
                                 <tr>
                                   <td align="center" valign="middle" style="width:160px;">
                                    <select class="required mws-select2 large" style="width:150px;"  name="itemname<?php echo $i; ?>"  id="itemname<?php echo $i; ?>" onChange="showUsers_invoice<?php echo $i; ?>(this.value)">
									 ...
									 <?php $sql3=$obj->SelectAll("stockvalidation"); 
									 foreach($sql3 as $pro){
										 if($pro->in_ac_id!=0)
										 {
										  ?>
                                    ...
                                    <td valign="middle" align="center" style="width:140px;">
                                    <input type="text" class="required small" name="itemd<?php echo $i; ?>"  id="itemd<?php echo $i; ?>" readonly> 							</td>
                                    ...
                                    <select class="mws-select2 large" style="width:150px;" name="tax<?php echo $i; ?>" multiple="1" id="tax<?php echo $i; ?>">
                                        <option value="">Chose Tax</option>
                                        <?php $sql4=$obj->SelectAll("account_module_newtax"); 
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th align="center" valign="middle"></th><th align="center" valign="middle"></th>
