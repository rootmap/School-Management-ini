                ...
                <!-- Panels Start -->
                	...
                	<div class="mws-panel-header">
                    	<span><i class="icon-table"></i>Salary Voucher</span> 
                            ...
                            <?php }else{?>
                            <a href="add_transaction_salary.php?branch_id=<?php echo $branch_id; ?>" class="btn btn-success"><i class="icon-plus"></i>Create Voucher</a>
                            <?php } ?>
                        	</span>
                    </div>
                    ...
                    <div class="mws-panel-body no-padding">
                        <table class="mws-datatable-fn mws-table">
							...
							$sql1=$obj->SelectAllByID("account_module_salary_voucher",$array);
							}
							$a=1;
							if(!empty($sql1))
							foreach($sql1 as $row)
