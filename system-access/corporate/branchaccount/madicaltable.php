...
<?php //include('header_footer_file/accjournalbalance.php'); ?>
                ...
                <?php if($id==1) { $data=$obj->SelectAll($table1); }
				elseif($id==2){ $data=$obj->SelectAll($table2); }
				elseif($id==3){ $data=$obj->SelectAll($table3); }
				elseif($id==4){ $data=$obj->SelectAll($table4); }
				elseif($id==5){ $data=$obj->SelectAll($table5); }
				elseif($id==6){ $data=$obj->SelectAll($table6); }
				elseif($id==7){ $data=$obj->SelectAll($table7); }
				else{ echo "no Data In Here ! :) ";}
				?>
                ...
                <!-- Panels Start -->
                	...
                	<div class="mws-panel-header">
                    	<span><i class="icon-table"></i>All Print Option</span> <span style="margin-left:850px; margin-top:-30px;">
                        </span>
                    </div>
                    <div class="mws-panel-body no-padding">
                        <table class="mws-datatable-fn mws-table">
                            ...
                            <tr>
                              ...
                              <td><a target="_blank" href="printmadical.php?pid=<?php echo $row->pid; ?>&amp;id=<?php echo $id; ?>" class="btn icon-print"></a></td>
                            </tr>
                            <?php $s++; endforeach; ?>
                            </tbody>
                        </table>
