								...
								$sql_leds=$obj->SelectAllByID("account_module_invoice_detail",array("invoice_id"=>$inid));
								 ...
								 if(!empty($sql_leds))
									foreach($sql_leds as $fetled)
									{
										...
										?>
                                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="addpayment.php?id=<?php echo $id; ?>&amp;cid=<?php echo $_GET['cid']; ?>&amp;branch_id=<?php echo $branch_id; ?>&amp;link_id=<?php echo $_GET['link_id'];  ?>&amp;due=<?php echo ($total+$tax_invoice)-$p;  ?>&amp;tam=<?php echo $total+$tax_invoice; ?>" class="btn"><i class="icon-attachment"></i> Add Payment</a></h3><hr>
                                    </div>
                                    ...
                                    <div class="mws-form-row" style="margin-top:-40px;">
                                    	<div class="mws-form-cols">
                                      	...
                                      	<div class="mws-form-col-2-8">
                                        		<label class="mws-form-label"  style="text-align:center; font-weight:bolder; font-size:19px;">Chose Currency</label>
                                            <div class="mws-form-item">
                                           		<input type="text" class="large" value="<?php 
							...
							foreach($sql_led as $fetled){ ?>
                                 <tr>
                                   <td align="center" valign="middle" style="width:160px; font-size:18px;">
                                    ...
                                    <?php echo $obj->SelectAllByVal("stockvalidation","id",$pid,"kg"); ?>
                                    </td>
