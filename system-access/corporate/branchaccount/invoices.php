...
<?php //include('header_footer_file/accjournalbalance.php'); ?>
                ...
                <!-- Panels Start -->
                	...
                	<div class="mws-panel-header">
                    	<span><i class="icon-table"></i> Sales Invoices</span> <span style="margin-top:-30px; float:right;"><a href="addinvoices.php" class="btn btn-success" id="mws-jui-dialog-mdl-btn"><i class="icon-plus"></i>Create a New Sales Invoices</a>
                    ...
                    <div class="mws-panel-body no-padding">
                        <table class="mws-datatable-fn mws-table">
                            ...
                            <tbody>
                            <?php
							$arrya=array("branch_id"=>$branch_id);
							$sql1=$obj->SelectAllByID("account_module_invoice",$arrya);
							$a=1;
							if(!empty($sql1))
							foreach($sql1 as $row)
							{
							...
							?>
                                <tr>
                                    <td valign="middle" align="center" style="width:30px;">
                               		<a class="anchorclass btn" rel="submenu1"><i class="icon-arrow-down-2"></i></a>
                                        <div id="submenu1" class="anylinkcss btn">
                                            ...
                                            <li><a href="viewinvoice.php?id=<?php echo $row->id; ?>&amp;cid=<?php echo $cid;  ?>&amp;branch_id=<?php echo $branch_id;  ?>&amp;link_id=<?php echo $link_id;  ?>&amp;currency=<?php echo $row->currency; ?>" class="btn"><i class="icon-tools"></i> Edit</a></li>
                                    ...
                                    <a href="printinvoice.php?id=<?php echo $row->id; ?>&amp;cid=<?php echo $fetuser->company_name;  ?>&amp;currency=<?php echo $row->currency; ?>" class="btn icon-print"></a>
