<?php
	...
	mysql_query("INSERT INTO budget_year (byear,curdate) VALUES ('$byear','$curdate')");
	$bid=mysql_insert_id();
	...
	mysql_query("INSERT INTO  budget (ladgerid,byear,aa,bb,cc,dd,ee,ff) VALUES ('".$ladgerid[$i]."','".$bid."','".$aa[$i]."','".$bb[$i]."', '".$cc[$i]."', '".$dd[$i]."', '".$ee[$i]."', '".$ff[$i]."')");
