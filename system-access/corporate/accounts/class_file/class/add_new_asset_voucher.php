...
$sql=mysql_query("INSERT INTO asset_voucher VALUES ('id','$customer_id','$date','$duedate','$subheading','$currency','$footer','$poso','$notes','0')");
...
{	
	...
	$sqlitemq=mysql_query("SELECT * FROM buy_product_asset_voucher WHERE id='$itemid'");
   ...
   $sqlss=mysql_query("INSERT INTO asset_voucher_detail (bill_id,pid,quantity,price,tax_id,tax_total,subtotal,totalamount,status) VALUES ('$jdid','".$_POST["itemname$i"]."','".$_POST["quantity$i"]."','".$_POST["price$i"]."','".$_POST["tax$i"]."','$totalvat','$totalprice','$totalamount','0')");
