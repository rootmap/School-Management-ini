<?php
	...
	$jd=$_POST['jd'];
	$jdate=$_POST['jdate'];
	$sql=mysql_query("INSERT INTO reservesurplus_description (jd,jddate) VALUES ('$jd','$jdate')");
    ...
    $query = "INSERT INTO reservesurplus_transaction (jdid, option_text, option_jd, option_debit, option_cradit) VALUES ('".$jdid."','".$option_a[$i]."','".$opt_a_d[$i]."','".$opt_a_debit[$i]."','".$opt_a_cradit[$i]."')";
		...
		else
		{
			...
			if($errflag) {
				...
				session_write_close();
				header("location: ../../rs_transaction.php");
				exit();
						}
