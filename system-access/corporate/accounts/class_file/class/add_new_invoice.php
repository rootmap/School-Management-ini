...
$sql=mysql_query("INSERT INTO invoice VALUES ('id','$customer_id','$date','$duedate','$subheading','$currency','$footer','$poso','$notes','0')");
...
{	
	...
	$sqlitemq=mysql_query("SELECT * FROM product WHERE id='$itemid'");
	$fetid=mysql_fetch_array($sqlitemq);
	$income_account_id=$fetid['in_ac_id'];
	$invoice_id="N".$jdid;
	mysql_query("INSERT INTO ladger (id,ladger_id,invoice_id,ladger_date,debit,cradit) VALUES ('', '$ledgerid','$invoice_id','$currentdate', '$totalamount', '0')");//dr value account reciveable
	mysql_query("INSERT INTO ladger (id,ladger_id,invoice_id,ladger_date,debit,cradit) VALUES ('', '$income_account_id','$invoice_id','$currentdate', '0', '$totalprice')");//cr value Income Account
	mysql_query("INSERT INTO ladger (id,ladger_id,invoice_id,ladger_date,debit,cradit) VALUES ('', '$main_tax_id','$invoice_id','$currentdate', '0', '$totalvat')");//cr value For Tax
	
	
	
   $sqlss=mysql_query("INSERT INTO invoice_detail (invoice_id,pid,quantity,price,tax_id,tax_total,subtotal,totalamount,status) VALUES ('$jdid','".$_POST["itemname$i"]."','".$_POST["quantity$i"]."','".$_POST["price$i"]."','".$_POST["tax$i"]."','$totalvat','$totalprice','$totalamount','0')");
