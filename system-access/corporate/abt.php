...
<!-- Mirrored from www.malijuthemeshop.com/live_previews/mws-admin/form_elements.html by HTTrack Website Copier/3.x [XR&CO'2010], Mon, 07 Jan 2013 09:12:04 GMT -->
<head>
<meta charset="utf-8">
    ...
    <!--<div id="mws-wrapper">
        ...
        <!--<div id="mws-sidebar">
        	...
        	<!--<div id="mws-searchbox" class="mws-inset">
            	<form action="http://www.malijuthemeshop.com/live_previews/mws-admin/typography.html">
          ...
          <div class="container">
            ...
            <div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                    	<form class="mws-form" action="aboutus.php" method="post">
                        	<div class="mws-form-row">
                            	<label class="mws-form-label">WYSIWYG</label>
                                <div class="mws-form-item">
                                	<textarea id="cleditor" name="cleditor" class="large"></textarea>
                                </div>
                            </div>
...
<!-- Mirrored from www.malijuthemeshop.com/live_previews/mws-admin/form_elements.html by HTTrack Website Copier/3.x [XR&CO'2010], Mon, 07 Jan 2013 09:12:20 GMT -->
</html>
