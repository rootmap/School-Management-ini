                ...
                <div class="mws-panel grid_8" style="margin-top:-50px;">
                    ...
                    <h3 align="center">Reporting Period 01/01/2013 To <?php echo date('d/m/Y');  ?></h3>
                        <table class="mws-table">
							...
							<tr><th valign="middle" align="left" style="padding-left:10px; font-size:18px;">Revenue</th>
                            ...
                            <tr><th valign="middle" align="left" style="padding-left:10px; font-size:15px">Gross Revenue</th>
                            ...
                            <tr>
                               <th valign="middle" align="left" style="color:#09F; font-size:15px; font-weight:bolder; padding-left:20px;">(- Less) Sales</th>
                               <th align="center" valign="middle" style="color:#000; font-size:15px; font-weight:bolder; color:#0CF">&nbsp;</th>
                             </tr>
                             <!--frieght in-->
                              <?php
							...
							?>
                                ...
                                <tr>
                                	<th valign="middle" align="left" style="padding-left:20px;">
                                    <a style="color:#09C; font-size:15px; font-weight:bolder;" href="viewledger.php?ladger_id=<?php echo $inid_sales_discount; ?>"><?php echo $row_sales_discount['head_sub_list_name']; ?></a>
                                    </th>
                                    <td align="center" valign="middle" style="color:#09C; font-size:18px; font-weight:bolder;"><strong>
									<?php 
							...
							?>
                                ...
                                <tr>
                                	<th valign="middle" align="left" style="padding-left:20px;">
                                    <a style="color:#09C; font-size:15px; font-weight:bolder;" href="viewledger.php?ladger_id=<?php echo $inid_sales_return; ?>"><?php echo $row_sales_return['head_sub_list_name']; ?></a>
                                    </th>
                                    <td align="center" valign="middle" style="color:#09C; font-size:18px; font-weight:bolder;"><strong>
									<?php 
                            ...
                            <tr><td colspan="2"></td></tr>
                            <tr><th valign="middle" align="left" colspan="2" style="padding-left:10px;">Less</th></tr>
                            <?php
							...
							while($row=mysql_fetch_array($ld))
							{
							 ...
							 ?> 
                            <tr><th valign="middle" align="left" style="padding-left:10px; font-size:15px">Net Revenue</th>
                                <th align="center" valign="middle" style="color:#000; font-size:15px; font-weight:bolder;"><?php $netrevenue=$gettotalrevenue-$salesexpense-$sales_discount-$sales_return;
                            ...
                            <tr>
                              <th valign="middle" align="left" style="padding-left:10px; font-size:15px">Other Income</th>
                              <th align="center" valign="middle" style="color:#000; font-size:15px; font-weight:bolder;"></th>
                            </tr>
                            <?php
							...
							while($row_o_i=mysql_fetch_array($sql_o_i))
							{
								...
								?>
									...
									<tr>
										<th valign="middle" align="left" style="padding-left:20px;">
										<a style="color:#09C; font-size:15px; font-weight:bolder;" href="viewledger.php?ladger_id=<?php echo $inid_other_income; ?>"><?php echo $row_other_income['head_sub_list_name']; ?></a>
										</th>
										<td align="center" valign="middle" style="color:#09C; font-size:18px; font-weight:bolder;"><strong>
										<?php 
                            ...
                            <tr><td colspan="2"></td></tr>
                            <tr>
                              <th valign="middle" align="left" style="padding-left:10px;">Total Other Income</th><th><?php $chktoi=substr($total_other_income,0,1);
							  if($chktoi!="-")
							  {
								  echo $total_other_income;
							  }
							  else
							  {
								  echo substr($total_other_income,1,200);
							  }
							  ?></th>
                            </tr>
                            <tr>
                              <th valign="middle" align="left" style="padding-left:10px;">Total Income</th><th><?php $chkti=substr($total_other_income,0,1);
							  if($chkti!="-")
							  {
								  echo $tincome=$total_other_income+$netrevenue;
							  }
							  else
							  {
								  echo $tincome=substr($total_other_income,1,200)+$netrevenue;
							  }
							  ?></th>
                            </tr>
                            <tr><th valign="middle" align="left" colspan="2" style="padding-left:10px;">Cost of Goods Sold (COGS)</th></tr>
                            <tr>
                            <th valign="middle" align="left" style="padding-left:10px;">Beginning Inventory Value</th>
                            <td align="center" valign="middle" style="color:#09C; font-size:18px; font-weight:bolder;">
							<?php
							$iyear=date('Y')-1;
							...
							?>
                                ...
                                <tr>
                                    ...
                                    <td align="center" valign="middle" style=" font-size:14px; font-weight:bolder;"><strong>
									<?php 
							 ...
							 ?>
                             <tr>
                               <th valign="middle" align="left" style="color:#09F; font-size:15px; font-weight:bolder; padding-left:20px;">(+Add)</th>
                               <th align="center" valign="middle" style="color:#000; font-size:15px; font-weight:bolder; color:#0CF">&nbsp;</th>
                             </tr>
                             <tr><th valign="middle" align="left" style="color:#09F; font-size:15px; font-weight:bolder; padding-left:20px;"> Direct Expense</th>
                                <th align="center" valign="middle" style="color:#000; font-size:15px; font-weight:bolder; color:#0CF"><?php echo number_format($cogs,2); ?></th>
                            </tr>
                             <!--frieght in-->
                              <?php
							...
							?>
							 ...
							 ?>
                             <tr>
                                  <th valign="middle" align="left" style="padding-left:10px;"></th>
                                  <td align="center" valign="middle" style="color:#09C; font-size:18px; font-weight:bolder;"><?php
								    echo number_format($begininginventory+$fr+$cogs,2);
								  ?></td>
                            </tr> 
                             <tr>
                               <th valign="middle" align="left" style="color:#09F; font-size:15px; font-weight:bolder; padding-left:20px;">(- Less) Purchase</th>
                               <th align="center" valign="middle" style="color:#000; font-size:15px; font-weight:bolder; color:#0CF">&nbsp;</th>
                             </tr>
                             <!--purchase_discount-->
                              <?php
							...
							?>
                                ...
                                <tr>
                                	<th valign="middle" align="left" style="padding-left:20px;">
                                    <a style="color:#09C; font-size:15px; font-weight:bolder;" href="viewledger.php?ladger_id=<?php echo $inid_purchase_discount; ?>"><?php echo $row_purchase_discount['head_sub_list_name']; ?></a>
                                    </th>
                                    <td align="center" valign="middle" style="color:#09C; font-size:18px; font-weight:bolder;"><strong>
									<?php 
							...
							?>
                                ...
                                <tr>
                                	<th valign="middle" align="left" style="padding-left:20px;">
                                    <a style="color:#09C; font-size:15px; font-weight:bolder;" href="viewledger.php?ladger_id=<?php echo $inid_purchase_return; ?>"><?php echo $row_purchase_return['head_sub_list_name']; ?></a>
                                    </th>
                                    <td align="center" valign="middle" style="color:#09C; font-size:18px; font-weight:bolder;"><strong>
									<?php 
                             ...
                             <tr>
                               <th valign="middle" align="left" style="padding-left:10px;">Net Direct Expense</th>
                               <td align="center" valign="middle" style="color:#09C; font-size:18px; font-weight:bolder;"><?php echo $netdiorectexpense=$cogs+($purchase_discount+$purchase_return); ?></td>
                             </tr>
                             <tr>
                                  <th valign="middle" align="left" style="padding-left:10px;">End Inventory Value</th>
                                  <td align="center" valign="middle" style="color:#09C; font-size:18px; font-weight:bolder;"><?php
								    echo number_format($endinventory,2);
								  ?></td>
                            </tr> 
                            <tr><th valign="middle" align="left" style="padding-left:10px; font-size:15px">Total Cost of Goods Sold (COGS)</th>
                                <th align="center" valign="middle" style="color:#000; font-size:15px; font-weight:bolder;"><?php 
                            ...
                            <tr><th valign="middle" align="left" style="padding-left:10px; font-size:15px"></th>
                                <th align="center" valign="middle" style="color:#000; font-size:15px; font-weight:bolder;"></th>
                            </tr>
                            <tr>
                                <th valign="middle" align="left" style="padding-left:10px; font-size:20px">Gross Profit/(Loss)</th>
                                <th align="center" valign="middle" style="color:#000; font-size:20px; font-weight:bolder;"><?php 
                            ...
                            <!--operating expenses-->
                            <tr><td colspan="2"></td></tr>
                            <tr><th valign="middle" align="left" colspan="2" style="padding-left:10px;">Operating Expenses</th></tr>
                            <?php
							$chkfourcountled=mysql_query("SELECT * FROM head_sub_list WHERE list_of_head_accounts_id='4' AND list_of_sub_head_accounts_id='2' AND list_of_sub_head_list_id!='35'");
							$opex=0;
							while($cogsexpense=mysql_fetch_array($chkfourcountled))
							...
							?>
							 ...
							 ?> 
                            <tr><th valign="middle" align="left" style="padding-left:10px; font-size:15px">Total Operating Expenses</th>
                                <th align="center" valign="middle" style="color:#000; font-size:15px; font-weight:bolder;"><?php echo number_format($opex,2); ?></th>
                            </tr>
                            <tr><th valign="middle" align="left" style="padding-left:10px; font-size:15px">&nbsp;</th>
                                <th align="center" valign="middle" style="color:#000; font-size:15px; font-weight:bolder;"></th>
                            </tr>
                            <tr>
                                <th valign="middle" align="left" style="padding-left:10px; font-size:20px">NET PROFIT/(Loss)</th>
                                <th align="center" valign="middle" style="color:#000; font-size:20px; font-weight:bolder;"><?php  $netprofit=$gross_profit-$opex;
								...
								{
									mysql_query("UPDATE income_statement SET amount='$netprofit',date='$date' WHERE year='$year'");
								}
								else
								{
									mysql_query("INSERT INTO income_statement (amount,year,date) VALUES ('$netprofit','$year','$date')");
								}
								?></th>
                            </tr>
                            <tr><th valign="middle" align="left" style="padding-left:10px; font-size:15px">&nbsp;</th>
