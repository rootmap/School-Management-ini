							...
							?>
                                <tr>
                                    ...
                                    <td style="font-size:12px; font-weight:bolder; text-align:center;">
										...
										if($wow->status==0){
										?>
                                    	<a href="payment_receive.php?payment_confirm=<?php echo $wow->id; ?>" class="btn icon-picassa-2"></a>
                                        <a href="payment_receive.php?print=<?php echo $wow->id; ?>" class="btn icon-print"> Print</a>
                                        <a href="payment_receive.php?del=<?php echo $wow->id; ?>" class="btn icon-trash"> Delete</a>
                                        <?php }else{ ?>
                                        <a href="#" class="btn icon-check"></a>
                                        <a href="payment_receive.php?print=<?php echo $wow->id; ?>" class="btn icon-print"></a>
                                        <?php } ?>
                                    </td>
                                </tr>
                            <?php 
