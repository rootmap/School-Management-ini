...
{
	extract($_GET);
	$obj->deletesing("id",$del,"fees_paid_ledger");	
}
...
if(isset($_POST['upch']))
{
	...
	{
		if($obj->update("fees_paid_ledger",array("id"=>$id,"ledger_id"=>$ledger_id,"percent"=>$percent,"session_id"=>$session,"class_id"=>$class,"group_id"=>$group,"date"=>date('Y-m-d'),"status"=>1))==1)
		{
 ...
 ?>
                ...
                <div class="mws-panel grid_8">
                	...
                	<div class="mws-panel-header">
                    	<span><i class="icon-users"></i> Student Fees Paid Ledger </span>
                    </div>
                                        ...
                                        <?php
                                                ...
                                                <?php
                                                    ...
                                                    <ul>
                                                            ...
                                                            {
                                                            ?>
                                                            <li><a href="class_file/class/fees_paid_ladger.php?id=<?php echo $rowsss->id; ?>&amp;subhead=1&amp;name=<?php  echo $rowsss->head_title;  ?>&amp;status=<?php echo $rowsss->status;   ?>"><?php echo $rowsss->head_title; ?></a></li>
                                                            <?php
                                                            }
                                                            ?>
                                                        </ul>
                                        ...
                                        <?php
                                                ...
                                                <?php
                                                    ...
                                                    <ul>
                                                            ...
                                                            {
                                                            ?>
                                                            <li><a href="class_file/class/fees_paid_ladger.php?id=<?php echo $rowsss->id; ?>&amp;subhead=2&amp;name=<?php  echo $rowsss->head_title;  ?>&amp;status=<?php echo $rowsss->status;   ?>"><?php echo $rowsss->head_title; ?></a></li>
                                                            <?php
                                                            }
                                                            ?>
                                                        </ul>
                                        ...
                                        <?php
                                                ...
                                                <?php
                                                    ...
                                                    <ul>
                                                            ...
                                                            {
                                                            ?>
                                                            <li><a href="class_file/class/fees_paid_ladger.php?id=<?php echo $rowsss->id; ?>&amp;subhead=3&amp;name=<?php  echo $rowsss->head_title;  ?>&amp;status=<?php echo $rowsss->status;   ?>"><?php echo $rowsss->head_title; ?></a></li>
                                                            <?php
                                                            }
                                                            ?>
                                                        </ul>
                                        ...
                                        <?php
                                                ...
                                                <?php
                                                    ...
                                                    <ul>
                                                            ...
                                                            {
                                                            ?>
                                                            <li><a href="class_file/class/fees_paid_ladger.php?id=<?php echo $rowsss->id; ?>&amp;subhead=4&amp;name=<?php  echo $rowsss->head_title;  ?>&amp;status=<?php echo $rowsss->status;   ?>"><?php echo $rowsss->head_title; ?></a></li>
                                                            <?php
                                                            }
                                                            ?>
                                                        </ul>
                                        ...
                                        <?php
                                                ...
                                                <?php
                                                    ...
                                                    <ul>
                                                            ...
                                                            {
                                                            ?>
                                                            <li><a href="class_file/class/fees_paid_ladger.php?id=<?php echo $rowsss->id; ?>&amp;subhead=5&amp;name=<?php  echo $rowsss->head_title;  ?>&amp;status=<?php echo $rowsss->status;   ?>"><?php echo $rowsss->head_title; ?></a></li>
                                                            <?php
                                                            }
                                                            ?>
                                                        </ul>
                            ...
                            <?php
                                    ...
                                    <?php
										...
										foreach($ss as $rowss)
										{
											$list_of_sub_head_list_id=$rowss->id;
										?>
                                            <li><a href="class_file/class/fees_paid_ladger.php?id=<?php echo $rowss->id; ?>&amp;subhead=6&amp;name=<?php echo $rowss->head_title; ?>&amp;status=<?php echo $rowss->status; ?>"><?php echo $rowss->head_title; ?></a></li>                               <?php											
										}
										?>
                               </ul>
                              </li>
                    ...
                    <div class="mws-panel-body no-padding">
                        ...
                        <table class="mws-table">
							...
							if(isset($_GET['report']))
							{
								...
								$class=$_GET['class'];
								$group=$_GET['group'];
								$sqld1=$obj->SelectAllByID_Multiple("fees_paid_ledger",array("branch_id"=>$school,"session_id"=>$session,"class_id"=>$class,"group_id"=>$group));
							}
							else
							{
								$sqld1=$obj->SelectAllByID_Multiple("fees_paid_ledger",array("branch_id"=>$school,"session_id"=>0));	
							}
							if(!empty($sqld1))
                        ...
                        <table class="mws-table">
                            ...
                            <tr>
                                ...
                                <tr>
                                 ...
                                 <?php 
							$sqld1=$obj->SelectAllByID_Multiple("fees_paid_ledger",array("branch_id"=>$school,"id"=>$_GET['edit']));
							if(!empty($sqld1))
							foreach($sqld1 as $row){ ?>
                                 <tr>
