...
foreach($sql_icpa as $row_ipca)
{
		...
		$getdutotal_ipca=$obj->SelectAllByID("account_module_ladger",array("ladger_id"=>$inid_row_ipca));
			$ipca_debit=0;
			$ipca_cradit=0;
                    ...
                    <h3 align="center">Reporting Period 01/01/2013 To <?php echo date('d/m/Y');  ?></h3>
						...
						$getdutotal=$obj->SelectAllByID_Multiple("account_module_ladger",array("ladger_id"=>$inid));
                            ...
                            <tr><td valign="middle" align="left"><strong>Total Liabilities and Equity</strong></td>
								...
								{
$obj->update("balancesheet",array("year"=>$year,"totalasset"=>$totalasset,"totalliability"=>$liabilitycurrent,"totalequity"=>$feq,"date"=>$date));
								}
								else
								{
$obj->insert("balancesheet",array("totalasset"=>$totalasset,"totalliability"=>$liabilitycurrent,"totalequity"=>$feq,"year"=>$year,"date"=>$date));
								}
