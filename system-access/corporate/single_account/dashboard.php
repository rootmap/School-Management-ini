            ...
            <div class="nws-panel grid_8 clearfix">
                ...
                <div class="mws-panel-body no-padding" style="text-align:center;">
                        ...
                        <a href="invoices.php" class="dash_panel">
                            ...
                            <div class="dash_label"> Student Invoice </div>
                        </a>
                        ...
                        <a href="customer.php" class="dash_panel">
                            ...
                            <div class="dash_label">Student List</div>
                        </a>
            	...
            	<div class="mws-panel grid_4">
                    ...
                    <div class="mws-panel-body no-padding">
                        <table class="mws-table-fn mws-table">
							...
							{
								$inid=$row->id; 
								$getdutotal=$obj->SelectAllByID_Multiple("account_module_ladger",array("ladger_id"=>$inid,"branch_id"=>$school));
									$debit=0;
									$cradit=0;
								if(!empty($getdutotal))	
							...
							?>
                                <tr>
									...
									if($getch!='-')
									{ echo number_format($netm,2); $balance+=$netm; }
									else
									{ echo "(".number_format(substr($netm,1,200),2).")"; $balance+=$netm; }  
                ...
                <div class="mws-panel grid_4">
                	<div class="mws-panel-header">
                    	<span><i class="icon-user"></i> Student Accounts Status </span>
                    </div>
                    <div class="mws-panel-body no-padding">
                        <table class="mws-datatable-fn mws-table">
							...
							$customer_paid=0;
							$customer_balance=0;
							$ld=$obj->SelectAllByID("ams_student_list",array("school_id"=>$school));
							if(!empty($ld))
							foreach($ld as $row)
							{
							...
							?>
                                <tr>
                                	<td valign="middle" align="left">
                                    <a style="color:#000; font-size:10px;" href="customer.php?view=<?php echo $inid; ?>"><?php echo $row->id; ?>. <?php echo $row->name; ?></a>
                                    </td>
                                    <td valign="middle" align="left">
							...
							?>
                             ...
                             <?php								
								...
								foreach($lde as $row)
								{
									...
									$inid=$row->id; 
									$getdutotal=$obj->SelectAllByID_Multiple_NotOne("account_module_ladger",array("ladger_id"=>$inid,"branch_id"=>$school),"ladger_id","41");
											$debit=0;
											$cradit=0;
										if(!empty($getdutotal))		
										foreach($getdutotal as $due)
