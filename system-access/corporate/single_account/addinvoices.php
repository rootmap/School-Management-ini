                                ...
                                <div class="mws-button-row">
                                    ...
                                    <h3>
                                        <i style="margin-top:-15px;" class="icon-pushpin"></i> 
                                        	Invoice 
                                        <?php 
										@$chkinvoice=$obj->SelectAll_Last_ID("account_module_invoice","id"); 
											if($chkinvoice==0) 
											{ echo "1"; } 
											else 
											{ echo $chkinvoice+1; } 
                                    	...
                                    	<div class="mws-form-cols">
                                      	<div class="mws-form-col-2-8">
                                           ...
                                           <select class="required mws-select2 large" style="text-align:center;" name="customer_id">
											   ...
											   <?php
                                               $sql1=$obj->SelectAll("ams_student_list");
											   if(!empty($sql1))
                                               foreach($sql1 as $row)
                                               {
                                               ?>      
                                      	...
                                      	<div class="mws-form-col-2-8">
                                        		<label class="mws-form-label"  style="text-align:center; font-weight:bolder; font-size:19px;">Select Month</label>
                                            <div class="mws-form-item">
                                            	<input type="hidden" name="currency" value="5">
                                                <input type="hidden" value="<?php echo $school; ?>"  name="branch_id">
                                                <select class="required mws-select2 large"  name="month_id" style="text-align:center;">
                                                <option value="">Choose Month</option>
											   <?php
											   for($i=1; $i<=12; $i++)
                                               {
                                               ?>      
                                                <option <?php if(date('m')==$i){ ?> selected <?php } ?> value="<?php echo $i; ?>"><?php echo $obj->month($i); ?></option>
                                                <?php
                                                }
                                                ?>
                                                </select>
                                 ...
                                 <tr>
                                   <td align="center" valign="middle" style="width:160px;">
                                    <select class="required mws-select2 large" style="width:150px;"  name="itemname<?php echo $i; ?>"  id="itemname<?php echo $i; ?>" onChange="showUsers_invoice<?php echo $i; ?>(this.value)">
									 ...
									 <?php $sql3=$obj->SelectAll("account_module_product"); 
									 foreach($sql3 as $pro){
										 if($pro->in_ac_id!=0)
										 {
										  ?>
                                    ...
                                    <input type="text" class="required small" style="width:90px;" placeholder="Description"  name="itemd<?php echo $i; ?>"  id="itemd<?php echo $i; ?>" readonly> 
                                    </td>
                                    <td valign="middle" align="center" style="width:60px;">
                                    <input type="text" class="required small" style="width:50px; text-align:right; font-weight:bolder;" placeholder="0"  name="quantity<?php echo $i; ?>" id="quantity<?php echo $i; ?>" onKeyUp="this.form.am<?php echo $i; ?>.value = this.form.quantity<?php echo $i; ?>.value * this.form.price<?php echo $i; ?>.value;">
                                    </td>
                                   	<td valign="middle" align="center" style="width:110px;" id="priceff">
       								<input type="text" class="required small" style="width:100px; text-align:right;" placeholder="0"  name="price<?php echo $i; ?>" id="price<?php echo $i; ?>" >
       								</td> 
                                    ...
                                    <td style="width:100px;" align="right"><input type="text" class="required small" style=" text-align:right; font-weight:bold; font-size:18px; width:80px; background:none; border:0px;" name="am<?php echo $i; ?>" id="am<?php echo $i; ?>" value="0" readonly></td>
