                ...
                <div class="mws-panel grid_12">
                    ...
                    <div class="mws-panel-body no-padding">
                        <table class="mws-datatable mws-table">
                            ...
                            <tbody>
                            <?php 
							$qq=$obj->SelectAll("account_module_invoice_payment");
							if(!empty($qq))
							foreach($qq as $wow)
							{
							?>
                                <tr>
									...
									<a style="color:#03C !important; font-weight:bolder; font-size:16px;" href="viewinvoice.php?id=<?php echo $wow->invoice_id; ?>">Invoice - 
