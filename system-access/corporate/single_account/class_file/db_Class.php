...
class db_class {
	...
	function month($month)
   {
    ...
    function baseUrl($suffix = '') {
        ...
        $web_root = $protocol . $_SERVER['HTTP_HOST'] . "/" . "Dreams/corporate/single_account/";
		//$web_root = $protocol . $_SERVER['HTTP_HOST'] . "/" . "Dreams/Dreams/corporate/single_account/";
        $suffix = ltrim($suffix, '/');
	...
	function SelectAll_Last_ID($object,$value) {
        $count = 0;
        $fields = '';
        $con = $this->open();
        $query = "SELECT * FROM `$object` ORDER BY id DESC LIMIT 1";
	...
	function SelectAllByVal5($object, $field, $fval, $field2, $fval2,$field3, $fval3,$field4, $fval4,$field5, $fval5,$value) {
        $count = 0;
        $fields = '';
        $con = $this->open();
        $query = "SELECT * FROM `$object` WHERE `$field`='$fval' AND `$field2`='$fval2' AND `$field3`='$fval3' AND `$field4`='$fval4' AND `$field5`='$fval5'";
        $result = mysqli_query($con, $query);
        if ($result) {
            $count = mysqli_num_rows($result);
	...
	function SelectAllByVal6($object, $field,$fval,$field2,$fval2,$field3,$fval3,$field4,$fval4,$field5,$fval5,$field6,$fval6,$value) {
        $count = 0;
        $fields = '';
        $con = $this->open();
        $query = "SELECT * FROM `$object` WHERE `$field`='$fval' AND `$field2`='$fval2' AND `$field3`='$fval3' AND `$field4`='$fval4' AND `$field5`='$fval5' AND `$field6`='$fval6'";
        $result = mysqli_query($con, $query);
        if ($result) {
            $count = mysqli_num_rows($result);
