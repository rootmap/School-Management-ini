                ...
                <h2 align="center" style="margin-top:-20px; border-left:#666 medium dotted;  border-right:#666 medium dotted;"><i class="icon-archive"></i> OFFICE EXPENSE </h2>
                    ...
                    <div class="mws-panel-body no-padding">
                        <table class="mws-datatable-fn mws-table">
                            ...
                            <tbody>
                            <?php
							$obj->sql("SELECT * FROM office_expense_voucher");
							$a=1;
							...
							?>
                                <tr>
                                    ...
                                    <td valign="middle" align="center"><a style="font-size:14px; font-weight:bolder; color:#333;" href="view_officeexpense_voucher.php?id=<?php echo $row['id']; ?>&amp;d=<?php echo $row['dr']; ?>&amp;c=<?php echo $row['cr']; ?>&amp;date=<?php echo $row['vdate'];  ?>&amp;des=<?php echo $row['description']; ?>&amp;taka=<?php echo $row['taka']; ?>"><?php echo $row['vdate']; ?></a></td>
                                    <td align="center" valign="middle"><?php echo "Office-Ex-V-".$row['id']; ?></td>
                                    <td align="center" valign="middle"><?php echo $row['taka']; ?></td>
