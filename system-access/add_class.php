...
{
	       if($obj->exists_multiple($table,array("name"=>$_POST['name'],"school_id"=>$school,"session_id"=>$_POST['session']))==0 && !empty($_POST['name']) && !empty($_POST['session']))
	{
				
        	if($obj->insert($table,array("name"=>$_POST['name'],"session_id"=>$_POST['session'],"school_id"=>$school,"date"=>date('Y-m-d'),"status"=>1))==1)
			
		{
			echo $obj->Success("Class Saved Successfully",$obj->filename());	
		}
		else
		{
			echo $obj->Error("Class Saved Failed",$obj->filename());	
		}
	}
			else
			{
                ...
                <div class="st_detail_topbar">
                    <a href="#">
                        <div class="topbar_small_div left ">
                            ...
                            <div class="topbar_small_div_text left height-30">CLASS</div>
                        </div>
                        <div class="topbar_small_div_text2 left height-30"><h2>ADD CLASS</h2></div>
                    </a>
                ...
                <div style="clear:both; ">
                    ...
                    <div class="admission_div shadow_inner" style="margin-top: 20px; height:auto;">
                        <div class="admission_text_div height-40" style="border-bottom: 5px #CCCCCC ridge;">
                            <h2 class="margin_left30"><left>ADD CLASS :</left></h2>
                        </div>
                       
                        <div id="classshow" class="admission_form_div width-col2 auto-position">
                        <form action="" method="post" name="class">
                            ...
                            <li class="admission_form_div_label height-30 width-label-200 left">Session<span class="right">:</span></li>
                             ...
                             <li class="admission_form_div_label height-30 width-label-200 left">Add Class / Course<span class="right">:</span></li>
                                <li class="admission_form_div_label height-30 width-label-250 right">
                                    <input name="name" placeholder="Type Class / Course Name Here" class="textbox"/>
                                </li>
                        ...
                        <div style="padding:10px;" class="width-auto height-auto">
                          <table cellpadding="0" cellspacing="1" border="0" class="display" id="example">
                                    ...
                                    <tbody style="font-weight:500;">
                                        ...
                                        <td class="center">
                                        <a title="Edit class" onclick="classedit('<?php echo $row->id; ?>')" href="#"><i class="fa fa-edit"></i></a>
                                        </td>
                                        <td class="center">
