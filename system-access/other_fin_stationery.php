...
if(isset($_POST['save']))
{
    ...
    $obj->insert($table,array("roll"=>$_POST['roll'],"admission"=>$_POST['admission'],"receipt"=>$_POST['receipt'],"school_id"=>$school,"date"=>date('Y-m-d'),"school_id"=>$school,"status"=>1));
        ...
        foreach($_POST['taka'] as $index=>$nn):
			...
			$obj->insert($table2,array("roll"=>$_POST['roll'],"total"=>$_POST['take_t'][$index],"account_id"=>$_POST['admission'],"amount"=>$_POST['taka'][$index],"receipt_number"=>$_POST['receipt'],"account_name_id"=>$_POST['account_name'][$index],"school_id"=>$school,"date"=>date('Y-m-d'),"status"=>1));
