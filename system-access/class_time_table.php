    ...
    <head>
        ...
        <script>
            function categoryy(str)
            {
                ...
                xmlhttp.open("GET", "ajx/time_table_category.php?s=" + str, true);
                xmlhttp.send();
            }
        </script>
         ...
         <script>
            function showcategory(str)
            {
                ...
                xmlhttp.open("GET", "ajx/time_table.php?k=" + str+"&group="+group, true);
                xmlhttp.send();
				}
				else if(str == "2")
				{
                group=document.getElementById('group').value;
                xmlhttp.open("GET", "ajx/time_table1.php?r=" + str+"&group="+group, true);
                xmlhttp.send();
				}
				else if(str == "3")
				{
                group=document.getElementById('group').value;
                xmlhttp.open("GET", "ajx/time_table2.php?g=" + str+"&group="+group, true);
                xmlhttp.send();
				}
				else if(str == "4")
				{
                group=document.getElementById('group').value;
                xmlhttp.open("GET", "ajx/time_table3.php?h=" + str+"&group="+group, true);
                xmlhttp.send();
				}
            }
        </script>
	   ...
	   table{text-align:center; font-size:14px; color:rgba(255,255,255,1);}
            ...
            <div class="st_detail_body">
                <div class="st_detail_topbar">
                    <a href="#">
                        ...
                        <div class="topbar_small_div_text2 left height-30"><h2>TIME TABLE</h2></div>
                    </a>
