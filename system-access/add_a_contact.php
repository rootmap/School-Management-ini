...

{
			...
			if($obj->exists_multiple($table,array("name"=>$_POST['name'],"group_id"=>$_POST['group'],"category_id"=>$_POST['category'],"info"=>$_POST['info'],"gender"=>$_POST['gener'],"number"=>$_POST['number'],"school_id"=>$school))==0 
			&& !empty($_POST['name'])
			&& !empty($_POST['group'])
	...
	{
				if($obj->insert($table,array("name"=>$_POST['name'],"group_id"=>$_POST['group'],"category_id"=>$_POST['category'],"info"=>$_POST['info'],"gender"=>$_POST['gener'],"number"=>$_POST['number'],"school_id"=>$school,"date"=>date('Y-m-d'),"status"=>1))==1)
                ...
                <div style="clear:both; ">
                  <div class="admission_div shadow_inner" style="margin-top: 20px; height:auto;">
                      <div class="st_group_text_div2 height-40" >
                            <h2 class="margin_left30"><left>Add A Contact To Group</left></h2>
                    </div>
                    <form action="" method="post" name="contaact">
