...
{
	if($obj->exists_multiple($table,array("name"=>$_POST['name'],"taka"=>$_POST['taka'],"school_id"=>$school))==0 && !empty($_POST['name']))
	{
				
        	if($obj->insert($table,array("name"=>$_POST['name'],"taka"=>$_POST['taka'],"school_id"=>$school,"date"=>date('Y-m-d'),"status"=>1))==1)
    ...
    <head>
        ...
        <script>
            function subjectedit(str)
            {
                ...
                xmlhttp.open("GET", "ajx/edit_st_finence.php?s=" + str, true);
                xmlhttp.send();
            }
        </script>
    </head>
            ...
            <div class="st_detail_body">
                <div class="st_detail_topbar">
                    <a href="#">
                        ...
                        <div class="topbar_small_div_text2 left height-30"><h2>ADD STUDENT FINANCE</h2></div>
                    </a>
                        ...
                        <div style="padding:10px;" class="width-auto height-auto">
                          <table cellpadding="0" cellspacing="1" border="0" class="display" id="example">
                                    ...
                                    <tbody style="font-weight:500;">
                                        ...
                                        <td class="center"><a href="#" id="edit" name="edit" onclick="subjectedit('<?php echo $row->id; ?>')"><i class="fa fa-edit"></i></a></td>
                                        <td class="center">
