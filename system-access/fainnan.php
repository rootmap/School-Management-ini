...
if(isset($_POST['save']))
{
    ...
    $obj->insert($table,array("roll"=>$_POST['roll'],
	...
	"school_id"=>$school));
        ...
        foreach($_POST['taka'] as $index=>$nn):
			if($obj->exists_multiple($table,array("roll"=>$_POST['roll'],
			"admission"=>$_POST['admission'][$index],
			"total_taka"=>$_POST['taka'][$index],
			"receipt"=>$_POST['receipt'],
			"school_id"=>$school))==0)
			{
        	
			
			$obj->insert($table2,array("roll"=>$_POST['roll'],
			"total"=>$_POST['taka_t'][$index],
			"account_id"=>$_POST['admission'],
			"amount"=>$_POST['taka'][$index],
			"receipt_number"=>$_POST['receipt'],
			"account_name_id"=>$_POST['account_name'][$index],
			"totall"=>$_POST['totall'],
			"totalll"=>$_POST['to'],
			"totall_taka"=>$_POST['totall_taka'],
			"totall_name"=>$_POST['totall_name'],
			"school_id"=>$school,
			"date"=>date('Y-m-d'),
			"status"=>1));
...
<script>
        ...
        <style type="text/css">
            /* The CSS */
			 .hoo:hover{background:rgba(0,153,153,1);-moz-transition:all 600ms ease-in-out;-ms-transition:all 600ms ease-in-out;-o-transition:all 600ms ease-in-out;-webkit-transition:all 600ms ease-in-out;transition:all 600ms ease-in-out; }
            select {
                padding:3px;
                margin: 0;
...
<div class="clear"></div>
						...
						if(@$_GET['receipt'])
						 {
						 ?>
                <div id="printableArea" style="margin-top:10px; margin-left:auto;margin-right:auto; width:100%; padding:10px;">
                   <?php
                   ...
                   <tr>
							...
							$name=$obj->SelectAllByVal("ams_admission","admition",$row->admission,"name");  
                                        ...
                                        <td></td>
                                          ...
                                          <td colspan="1" class=" a-left "style="padding-left:25px;padding-bottom:5px; padding-top:5px;">
                                            ...
                                            <tr style="background:#d8d8d8; color:#000; font-weight:900; font-size:12px;">
                                                 <td class="center" style="padding:10px;">S/L.</td>
									 ...
									 ?>
                                            ...
                                            <tr style="background:#ececec;">
                                                ...
                                                <td  class="center "><?php echo $s;?></td>
                                                <td  class=" a-left">
                                                 Tuition Fee <?php echo $rww->totall_name; ?>  To <?php echo $rww->totalll; ?>
                                                </td>
                                            ...
                                            <td class="center"><?php $sum11=$sum+$rww->totall_taka; echo $sum11; ?> Tk</td>
                                            </tr>
                                            ...
                                            <td class="center">
                                            <?php $jj=$sum1+$rww->totall;  $due=$jj-$sum11; echo $due; ?> Tk
                                            </td>
                                            </tr>
                                            
                                            <tr style="background:#d8d8d8; color:#000;">
                                            <td style="padding-left:20px;" colspan="4">In Word: 
											<?php echo convert_number_to_words($sum11)." Taka Only."; ?></td>
                                            </tr>
