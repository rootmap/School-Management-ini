            ...
            <div class="st_detail_body">
                <div class="st_detail_topbar">
                    <a href="#">
                        ...
                        <div class="topbar_small_div_text2 left height-30"><h2>MASSAGES BOOK</h2></div>
                    </a>
                        ...
                        <div id="subjectshow" class="admission_form_div width-col2 auto-position" style="height:auto;">
                            ...
                            <ul>
                                ...
                                <li class="admission_form_div_label height-30 width-label-250 right">
                                    <input placeholder="Type MASSAGES Name" name="name" class="textbox"/>
                                </li>
                                ...
                                <li class="admission_form_div_label height-auto width-auto right">
                                    <textarea name="text" placeholder="Type massages book" class="text_area"></textarea>                                     <script>
