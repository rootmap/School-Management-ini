...
{  
	...
	if($obj->exists($table,array("group_id"=>$_POST['group'],
	...
	{
        if($obj->insert($table,array("group_id"=>$_POST['group'],
	"id_number"=>$_POST['id_number'],
	"joining_date"=>$_POST['date'],
	"name"=>$_POST['name'],
	"department_id"=>$_POST['department'],
            ...
            <div class="st_detail_body">
                <div class="st_detail_topbar">
                    <a href="#">
                        ...
                        <div class="topbar_small_div_text2 left height-30"><h2>ADD PROFILE INFORMATION</h2></div>
                    </a>
                ...
                <div style="clear:both; ">
                    ...
                    <form action="" method="post" name="mngmt" enctype="multipart/form-data">
                        <div class="total_send_sms_div_top auto-position color_1 shadow_inner" style="color:rgba(0,51,51,1);">
                         <ul>
                               ...
                               <li class="add_st_form_div_label_view_details height-30 width-label-200 left" style="text-align:center; margin-left:10px;">Select A Group Name<span style="color:rgba(153,0,0,1);">&lowast;</span>: </li>
                            ...
                            <li class="add_st_form_div_label_view_details height-30 width-label-100 left" style="text-align:center; margin-left:15px;">ID Number<span style="color:rgba(153,0,0,1);">&lowast;</span> :</li>
                                <li class="admission_form_div_label height-30 width-label-130 margin-top-10 left " style="margin-right:10px; margin-left:10px;">
                                    <input placeholder="ID number" value="<?php echo $obj->RandNumber(8);?>" name="id_number" style="height:15px; width:120px; border-radius:7px; border:1px #CC0000 solid; padding:5px;" class=""/>
                                </li>
                                
                                <li class="add_st_form_div_label_view_details height-30 width-label-130  left" style="text-align:center; margin-left:15px;">Joining Date<span style="color:rgba(153,0,0,1);">&lowast;</span>:</li> 
                                <li class="admission_form_div_label height-30 width-label-130 margin-top-10  left" style="margin-right:15px;">
                                    <input style="height:15px; width:120px; border-radius:7px; border:1px #CC0000 solid; padding:5px;" placeholder="&nbsp" readonly="readonly" id="calendar" name="date" value="<?php $dt=date('y-m-d'); { echo $dt;}?>" class="textbox_exm"/>
                                </li>
                    ...
                    <div class="admission_div shadow_inner" style="margin-top: 20px; height:auto; ">
                        ...
                        <div class="admission_form_div width-col2 auto-position auto-height" style="color:rgba(0,51,51,1);">
                            ...
                            <ul>
                                <li class="admission_form_div_label height-30 width-label-200 left">Name <span style="color:rgba(153,0,0,1);">&lowast;</span> <span class="right">:</span></li>
                                <li class="admission_form_div_label height-30 width-label-250 right">
                                    <input placeholder="Type Student's Name Here" name="name" class="textbox"/>
                                </li>
                                <li class="admission_form_div_label height-30 width-label-200 left">Information <span style="color:rgba(153,0,0,1);">&lowast;</span><span class="right">:</span></li>
                                <li class="admission_form_div_label height-30 width-label-250 right">
                                    
                                       <input placeholder="Type department Here" name="department" class="textbox"/>
...
-->
                                ...
                                <li class="admission_form_div_label height-30 width-label-200 left">Position <span style="color:rgba(153,0,0,1);">&lowast;</span><span class="right">:</span></li>
                                <li class="admission_form_div_label height-30 width-label-250 right">
                                ...
                                <li class="admission_form_div_label height-30 width-label-200 left">Job Title <span style="color:rgba(153,0,0,1);">&lowast;</span><span class="right">:</span></li>
                                <li class="admission_form_div_label height-30 width-label-250 right">
                                    <input class="textbox" type="text" placeholder="Type your Job Title" name="job" >
                                ...
                                <li class="admission_form_div_label height-30 width-label-200 left">Status <span style="color:rgba(153,0,0,1);">&lowast;</span><span class="right">:</span></li>
                                <li class="admission_form_div_label height-30 width-label-250 right">
                                    <input name="status" type="text" placeholder="Type Status Here" class="textbox"/>
                                </li>
                                
                                <li class="admission_form_div_label height-30 width-label-200 left">Qualification<span class="right">:</span></li>
                                <li class="admission_form_div_label height-30 width-label-250 right">
                                    <input class="textbox" type="text" placeholder="Type your Qualification" name="qualification" >
                                ...
                                <li class="admission_form_div_label height-30 width-label-200 left">Experience Info<span class="right">:</span></li>
                                <li class="admission_form_div_label height-30 width-label-250 right">
                                     <input name="experience" placeholder="Type Your Experience Info" class="textbox"/>
                                </li>
                                ...
                                <li class="admission_form_div_label height-30 width-label-250 right">
                                    <input type="text" name="m_name" placeholder="Type Mother's Name Here" class="textbox"/>
                                </li>
                                
                                <li class="admission_form_div_label height-30 width-label-200 left"> Date of Birth<span class="right">:</span></li>
                                <li class="admission_form_div_label height-30 width-label-250 right">
                                    <input id="calendar2" readonly="readonly" type="text" name="dob" placeholder="Type Date of Birth Here" class="textbox"/>
                                </li>
                                ...
                                <li class="admission_form_div_label height-30 width-label-200 left">Marital Status<span style="color:rgba(153,0,0,1);">&lowast;</span><span class="right">:</span></li>
                                <li class="admission_form_div_label height-30 width-label-250 right">
                                ...
                                <li class="admission_form_div_label height-30 width-label-250 right">
                                    <input placeholder="Type Spouse Name Here" name="spo" class="textbox"/>
                                </li>
                                
                                <li class="admission_form_div_label height-30 width-label-200 left">No of Children<span class="right">:</span></li>
                                <li class="admission_form_div_label height-30 width-label-250 right">
                                    <input name="children" placeholder="Type No of Children Here" class="textbox"/>
                                </li>
                                ...
                                <li class="admission_form_div_label height-30 width-label-250 right">
                                    <input name="number" placeholder="Type Mobile Number Here" class="textbox"/>
                                </li>
                                ...
                                <li class="admission_form_div_label height-30 width-label-200 left"> Image's<span class="right">:</span></li>
                                <li class="admission_form_div_label height-30 width-label-250 right">
                                ...
                                <li style="clear: both; display: block; width: 100%; padding: 10px; text-align: center;">
                                    ...
                                    <button type="submit" name="save" class=" height-35 div_btn">Submitt</button>
                                </li>
