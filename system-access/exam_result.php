    ...
    <head>
       ...
       <script>
        ...
        <script>
            function showstudent(str)
            {
                ...
                xmlhttp.open("GET", "ajx/show_student_result_r.php?k=" + str+"&group="+group, true);
                xmlhttp.send();
            }
        </script>
     ...
     <script>
            function showresult(str,admission,status)
            {
                ...
                xmlhttp.open("GET", "ajx/show_result.php?k=" + str+"&admission="+admission+"&status="+status, true);
                xmlhttp.send();
            }
        </script>
            ...
            <div class="st_detail_body">
             ...
             <!---------------------body start----------------------------------------------------------------->       
                   ...
                   <div class="exam_result_div_page" style="margin-top: 20px; ">
                       ...
                       <div id="result1" class="result_sheet">
