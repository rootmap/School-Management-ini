...
$table="cms_keyperson_managing_office_staff";
$w=150;
$h=150;
$thumb = "../gallery";
if(isset($_POST['save']))
{
	if (!empty($_FILES['photo']['name'])) {
		@$files=$obj->upload_image($w,$h,$thumb,"photo",'office_staff');
		$photo=$files;
	} else {
	...
	{
		if($obj->insert($table,array("name"=>$_POST['name'],"position"=>$_POST['position'],"photo"=>$photo,"school_id"=>$school,"date"=>date('Y-m-d'),"status"=>1))==1)
                ...
                <div class="st_detail_topbar">
                    <a href="#">
                        <div class="topbar_small_div left ">
                            ...
                            <div class="topbar_small_div_text left height-30">Staff</div>
                        </div>
                        <div class="topbar_small_div_text2 left height-30"><h2>Add New Office Staff</h2></div>
                    </a>
                ...
                <div style="clear:both; ">
                    ...
                    <div class="admission_div shadow_inner" style="margin-top: 20px; height:auto;">
                        <div class="admission_text_div height-40" style="border-bottom: 5px #CCCCCC ridge;">
                            <h2 class="margin_left30"><left>Add Office Staff Detail :</left></h2>
                        </div>
