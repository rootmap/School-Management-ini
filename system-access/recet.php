    ...
    <head>
        ...
        <script>
            function showallstd(str)
            {
                ...
                xmlhttp.open("GET", "ajx/show_view.php?k=" + str+"&group="+group, true);
                xmlhttp.send();
            }
        </script>
         ...
         <script>
            function showview(str)
            {
                ...
                xmlhttp.open("GET", "ajx/student_account_view1.php?r=" + str, true);
                xmlhttp.send();
            }
        </script>
            ...
            <div class="st_detail_body">
                <div class="st_detail_topbar">
                    <a href="#">
                        ...
                        <div class="topbar_small_div_text2 left height-30"><h3>ACADEMIC STUDENTS' ACCOUNTS</h3></div>
                    </a>
                        ...
                        <div class="st_fin_small_form_div width-col5 auto-position">
                            ...
                            <li class="add_st_form_div_label_view_details width-label-110 height-30 left">Group:</li>
                                <li class="add_st_form_div_label_view_details height-30 width-label-100 left">
                                    <select style="width:130px;" name="group" onchange="showallstd(this.value)" id="group" >
                                        <option>Group</option>
                                    </select>
                                </li>
                                </ul>
                                <ul style="margin-left:30px;">
                            <li id="dynamic1" style="clear: both; display: block; width: 100%; padding: 10px; text-align: center;">
...
<div class="clear"></div>
                        	...
                        	<div id="dynamic1" class="st_fin_small_div left margin_left5" >
                              <table style="font-size:12px;" cellpadding="0" cellspacing="1" border="0" class="display" id="example">
                                   ...
                                   ?>
                                              <tr class="">
                                                ...
                                                <td class="center hoo"><a onclick="showview('<?php echo $row->admition;?>')" href="#" name="roll" style="display:block;padding:3px;" class="hoo" id="roll"/><img src="images/Calculator-icon.gif" /></a></td>
                            ...
                            <div id="dynamic2" class="st_fin_small_div right" style="width:100%;" ></div>
                              <div class="clear"></div>
                             </div>
