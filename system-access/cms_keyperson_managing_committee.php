...
$table="cms_keyperson_managing_committee";
$w=150;
$h=150;
$thumb = "../gallery";
if(isset($_POST['save']))
{
	if (!empty($_FILES['photo']['name'])) {
		@$files=$obj->upload_image($w,$h,$thumb,"photo",'managing_committee');
		$photo=$files;
	} else {
	...
	extract($_POST);
	if($obj->exists_multiple($table,array("name"=>$_POST['name'],"school_id"=>$school))==0 && !empty($_POST['name']) && !empty($_POST['position']))
	{
		if($obj->insert($table,array("name"=>$_POST['name'],"position"=>$_POST['position'],"degree"=>$_POST['degree'],"photo"=>$photo,"school_id"=>$school,"date"=>date('Y-m-d'),"status"=>1))==1)
                ...
                <div class="st_detail_topbar">
                    <a href="#">
                        <div class="topbar_small_div left ">
                            ...
                            <div class="topbar_small_div_text left height-30">Committee</div>
                        </div>
                        <div class="topbar_small_div_text2 left height-30"><h2>Add New Managing Committee</h2></div>
                    </a>
                ...
                <div style="clear:both; ">
                    ...
                    <div class="admission_div shadow_inner" style="margin-top: 20px; height:auto;">
                        <div class="admission_text_div height-40" style="border-bottom: 5px #CCCCCC ridge;">
                            <h2 class="margin_left30"><left>Add Managing Committee Detail :</left></h2>
                        </div>
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            <ul>
                                ...
                                <li class="admission_form_div_label height-30 width-label-250 right">
                                    <input name="position" placeholder="Type Position Here" class="textbox" type="text" />
                                </li>
