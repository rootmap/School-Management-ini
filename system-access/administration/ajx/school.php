...
?>
   <?php 
   $array=array("eiin_number"=>$s);
    $date=$obj->SelectAllByID($table, $array);
	 if(!empty($date))
	  foreach ($date as $row):
   ?>
   <input name="school" readonly="readonly" value="<?php echo $row->acount_name; ?>" class="borber2 padding_5 width_94" type="text" placeholder="School/Collage Name"  />
