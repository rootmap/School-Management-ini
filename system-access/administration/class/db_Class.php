...
class db_class {
	...
	function SelectAllSearchall($object,$search) {
        $count = 0;
        $fields = '';
        $con = $this->open();
        ...
        $query = "SELECT * FROM `$object` WHERE $field2 LIKE'%$search%'";
        $result = mysqli_query($con, $query);
        if ($result) 
        {
            $count = mysqli_num_rows($result);
    ...
    function SelectAll_limit_order($object) {
        ...
        $fields = '';
        $con = $this->open();
        $query = "SELECT * FROM `$object` ORDER BY id DESC LIMIT 10";
        $result = mysqli_query($con, $query);
        if ($result) {
            $count = mysqli_num_rows($result);
	...
	function SelectAll_limit_order_20($object) {
        $count = 0;
        $fields = '';
        $con = $this->open();
        $query = "SELECT * FROM `$object` ORDER BY id DESC LIMIT 20";
        $result = mysqli_query($con, $query);
        if ($result) {
            $count = mysqli_num_rows($result);
