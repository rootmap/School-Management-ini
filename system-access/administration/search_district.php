...
<script>
            function showlist(str)
            {
                ...
                xmlhttp.open("GET", "ajx/eiin_number_list_district.php?s=" + str, true);
                xmlhttp.send();
            }
        </script>
  ...
  <!----------select start------------------------------------------------->       
    <div class="width_100 height_auto padding_top_10">
      <ul class="padding width_97 marging_left_right backgroung_3">
        <li class="left font_2 color_w line-height_25">Search By District :</li>
        <li class="left padding_left_10">
         <select class="padding_5 borber2 width-label-150 color_b font_11" name="eiin_number" id="" onchange="showlist(this.value)">
           ...
           <?php 
			 ...
			 foreach ($data as $row):
		   ?>
           <option value="<?php echo $row->divition; ?>"><?php echo $row->divition; ?></option>
           <?php endforeach; ?>
         </select>
       ...
       <?php 
         ...
         <tr class="backgroung_6 font_11">
           ...
           <td class="padding_5 font_14">
             <a name="edit" href="search_district.php?statuss=yes&amp;eiin=<?php echo $row->eiin_number; ?>&amp;status=3&amp;id=<?php echo $row->id; ?>">
												<?php 
           ...
           <td class="padding_5 font_14">
             <a name="edit" href="search_district.php?statuss1=yes&amp;eiin=<?php echo $row->eiin_number; ?>&amp;status=2&amp;id=<?php echo $row->id; ?>">
												<?php 
