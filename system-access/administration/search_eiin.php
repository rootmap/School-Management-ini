...
<script>
            function showlist(str)
            {
                ...
                xmlhttp.open("GET", "ajx/eiin_number_list.php?s=" + str, true);
                xmlhttp.send();
            }
        </script>
...
<div class="height-100 width_960 auto-position"> 
  ...
  <div class="width_960 height-20 marging_left_right"><?php include_once('class/esm.php'); ?></div>
  <div class="height-10 backgroung_3 width_960 marging_left_right"></div> 
  ...
  <!----------select start------------------------------------------------->       
    <div class="width_100 height_auto padding_top_10">
      <ul class="padding width_97 marging_left_right backgroung_3">
        <li class="left font_2 color_w line-height_25">Search By EIIN Number :</li>
        <li class="left padding_left_10">
         <select class="padding_5 borber2 width-label-150 color_b font_11" name="eiin_number" id="" onchange="showlist(this.value)">
           ...
           <?php 
			 ...
			 foreach ($data as $row):
		   ?>
           <option value="<?php echo $row->eiin_number; ?>"><?php echo $row->eiin_number; ?></option>
           <?php endforeach; ?>
         </select>
       ...
       <?php 
         ...
         <tr class="backgroung_6 font_11">
           ...
           <td class="padding_5 font_14">
             <a name="edit" href="search_thana.php?statuss=yes&amp;eiin=<?php echo $row->eiin_number; ?>&amp;status=3&amp;id=<?php echo $row->id; ?>">
												<?php 
           ...
           <td class="padding_5 font_14">
             <a name="edit" href="search_thana.php?statuss1=yes&amp;eiin=<?php echo $row->eiin_number; ?>&amp;status=2&amp;id=<?php echo $row->id; ?>">
												<?php 
