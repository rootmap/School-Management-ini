...
<?php include('includes/back.php'); ?>
                ...
                <div style="clear:both; ">
                    ...
                    <div class="menu_div auto-position shadow_inner" style="margin-top:15px;">
                         ...
                         <div class=" width-label-180 arial font-color-dark-red left space-top-5 bold margin_left10">&lowast; <span style="color:#036;">User Group Name :</span></div>
                        ...
                        <div class="width-label-200 left">
                          <select id="category" class="form-control secll select2" >
...
-->
   ...
   <button type="submit" name="submit" class="height-35 div_btn" onclick="showallstd('3')">Show Group</button>
