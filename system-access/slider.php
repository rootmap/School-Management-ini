...
if(isset($_POST['save']))
{
	...
	if (!empty($_FILES['photo']['name'])) {
            @$files =$obj->upload_image($w,$h,$thumb,"photo",'home_slider');
            $photo =$files;
	} else {
                ...
                <div class="st_detail_topbar">
                    <a href="#">
                        <div class="topbar_small_div left ">
                            ...
                            <div class="topbar_small_div_text left height-30">Slider</div>
                        </div>
                        <div class="topbar_small_div_text2 left height-30"><h2>Add Photo in Slider	</h2></div>
                    </a>
                ...
                <div style="clear:both; ">
                    ...
                    <div class="admission_div shadow_inner" style="margin-top: 20px; height:auto;">
                        <div class="admission_text_div height-40" style="border-bottom: 5px #CCCCCC ridge;">
                            <h2 class="margin_left30"><left>Add New Photo in Slider :</left></h2>
                        </div>
                       
                        <div id="sessionshow" class="admission_form_div width-col2 auto-position">
                        <form action="" method="post" enctype="multipart/form-data">
                            <ul>
                             	<li class="admission_form_div_label height-30 width-label-200 left">Add Photo Title<span class="right">:</span></li>
                                <li class="admission_form_div_label height-30 width-label-250 right">
                                    <input type="text" name="name" placeholder="Type Photo Title Here" class="textbox"/>
                                </li>
                                <li class="admission_form_div_label height-30 width-label-200 left">Upload Photo (924 X 422 ) <span class="right">:</span></li>
                                <li class="admission_form_div_label height-30 width-label-250 right">
