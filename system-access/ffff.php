...
<div class="clear"></div>
 ...
 <!----------------------select menu ends---------------------------------->
                            ...
                            <div id="dynamic2" class="st_fin_small_div right" style="width:98%;" ></div>
                           
                           
                           <div id="printableArea" style=" width:100%;float:left;">
                           <div id="ddddd" class="auto-position"  style=" width:90%;"></div>
                           </div>
